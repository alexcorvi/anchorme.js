(function (global, factory) {
	...
	function transform(input, options) {
	    ...
	    if (regex.protocolPresent.test(input)) {
	        protocol = "";
	    }
	    else if (!protocol) {
	        protocol = regex.emailRegex.test(input)
	            ? "mailto:"
	            : regex.fileRegex.test(input)
	                ? "file:///"
	                : "http://";
	    }
	    // truncation
